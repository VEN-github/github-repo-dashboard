...
<template>
  <div class="absolute pointer-events-none inset-0 mx-auto max-w-lg top-44">
    <canvas
      ref="canvasRef"
      class="w-[630px] cursor-grab opacity-0 transition-opacity duration-500 [contain:layout_paint_size]"
      width="1000"
      height="1000"
